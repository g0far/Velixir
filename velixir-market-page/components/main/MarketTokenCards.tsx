  ...
  return (
    <div
      ...
      style={{
        ...
        height: size,
        fontSize: size * 0.3,
        background: `linear-gradient(135deg, ${token.color}, ${token.colorSecondary})`,
        boxShadow: `0 0 10px ${token.color}44`,
      }}
    >
      {imgFailed ? (
        token.symbol.length <= 3 ? token.symbol.slice(0, 2) : token.symbol.slice(0, 1)
      ) : (
        <img
